...
/**
 * lee AC , but system error
 */
//Java：链表相交
public class P面试题_02_07IntersectionOfTwoLinkedListsLcci {

	@Test
	public void testResult() {
		Solution solution = new P面试题_02_07IntersectionOfTwoLinkedListsLcci().new Solution();        // TO TEST
	}
